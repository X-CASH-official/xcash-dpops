...
xcash_proof_of_stake:
	gcc -o xcash_proof_of_stake xcash_proof_of_stake.c functions/file_functions/file_functions.c functions/network_daemon_functions/network_daemon_functions.c functions/network_functions/network_functions.c functions/network_security_functions/network_security_functions.c functions/network_wallet_functions/network_wallet_functions.c functions/server_functions/server_functions.c functions/string_functions/string_functions.c functions/thread_functions/thread_functions.c functions/thread_server_functions/thread_server_functions.c tests/analysing_code_test/analysing_code_test.c tests/file_functions_test/file_functions_test.c tests/network_functions_test/network_functions_test.c tests/reset_variables_allocated_on_the_heap_test/reset_variables_allocated_on_the_heap_test.c tests/string_functions_test/string_functions_test.c tests/xcash_proof_of_stake_test.c $(CFLAGS) $(LDFLAGS)
