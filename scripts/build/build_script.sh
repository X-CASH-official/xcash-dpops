...
DELEGATES_WEBSITE_URL="https://github.com/X-CASH-official/XCASH_DPOPS_delegates_website.git"
...
XCASH_DPOPS_DELEGATE_FOLDER_DIR="${XCASH_DPOPS_DIR}delegates_website/"
DELEGATES_WEBSITE_DIR="${XCASH_DPOPS_INSTALLATION_DIR}XCASH_DPOPS_delegates_website/"
...
function start_processes()
{
  ...
  sleep 10s || return 1
  screen -dmS XCASH_DPOPS ${XCASH_DPOPS_DIR}build/XCASH_DPOPS || return 1
  echo -e "\n" >> ${LOGFILE_STEP_1_PROGRAMS} 2>&1 || return 1
}
...
function stop_processes()
{
  ...
  screen -XS "XCASH_DPOPS" quit || return 1
  echo -e "\n" >> ${LOGFILE_STEP_1_PROGRAMS} 2>&1 || return 1
}
