...
if [ "$IP_ADDRESS" == $MAIN_NODES_IP_ADDRESS ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_1} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_1} --rpc-bind-ip 0.0.0.0 --rpc-bind-port 18281 --confirm-external-bind --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.202" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_2} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_2} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.203" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_3} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_3} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.204" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_4} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_4} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.205" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_5} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_5} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.206" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_6} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_6} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.207" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_7} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_7} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.208" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_8} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_8} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.209" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_9} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_9} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.210" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_10} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_10} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.211" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_11} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_11} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.212" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_12} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_12} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.213" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_13} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_13} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.214" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_14} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_14} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.215" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_15} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_15} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.216" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_16} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_16} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.217" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_17} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_17} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.218" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_18} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_18} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.219" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_19} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_19} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
elif [ "$IP_ADDRESS" == "192.168.1.220" ]; then
  xfce4-terminal -e "bash -c \"${XCASH_DIR}xcashd --xcash-dpops-delegates-public-address ${TEST_WALLET_20} --xcash-dpops-delegates-secret-key ${TEST_WALLET_SECRET_KEY_20} --allow-local-ip --add-exclusive-node ${MAIN_NODES_IP_ADDRESS} --data-dir ${XCASH_BLOCKCHAIN_DIR}; bash\"" -T "xcashd" &
fi
