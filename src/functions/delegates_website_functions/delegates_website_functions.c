...
int server_receive_data_socket_get_delegates(const int CLIENT_SOCKET)
{
  ...
  // define macros
  #define DATABASE_FIELDS "public_address|public_key|about|website|team|server_specs|block_verifier_online_total_rounds|block_verifier_score|block_producer_block_heights|"
