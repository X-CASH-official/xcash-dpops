...
void socket_thread(const int CLIENT_SOCKET)
{
  ...
  else if (strlen(buffer) > 25 && strstr(buffer,"}") != NULL && strstr(buffer,"\",\r\n") != NULL)
  {
    ...
    if ((strncmp(data2,"XCASH_PROOF_OF_STAKE_TEST_DATA",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_SYNC_CHECK_DOWNLOAD",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_DOWNLOAD_FILE_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_DOWNLOAD_FILE_DOWNLOAD",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_SYNC_CHECK_DOWNLOAD",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_DOWNLOAD_FILE_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_DOWNLOAD_FILE_DOWNLOAD",BUFFER_SIZE) == 0 || strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_GET_PREVIOUS_CURRENT_NEXT_BLOCK_VERIFIERS_LIST",BUFFER_SIZE) == 0 || strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_GET_CURRENT_BLOCK_VERIFIERS_LIST",BUFFER_SIZE) == 0 || strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_RESERVE_BYTES_DATABASE_SYNC_CHECK_ALL_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_RESERVE_PROOFS_DATABASE_SYNC_CHECK_ALL_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_RESERVE_PROOFS_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_RESERVE_BYTES_DATABASE_SYNC_CHECK_ALL_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_RESERVE_BYTES_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_DELEGATES_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_STATISTICS_DATABASE_SYNC_CHECK_UPDATE",BUFFER_SIZE) == 0 || strncmp(data2,"NODE_TO_BLOCK_VERIFIERS_ADD_RESERVE_PROOF",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_INVALID_RESERVE_PROOFS",BUFFER_SIZE) == 0 || strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REGISTER_DELEGATE",BUFFER_SIZE) == 0 || strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_RECOVER_DELEGATE",BUFFER_SIZE) == 0 || strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_UPDATE_DELEGATE",BUFFER_SIZE) == 0 || strncmp(data2,"MAIN_NETWORK_DATA_NODE_TO_BLOCK_VERIFIERS_CREATE_NEW_BLOCK",BUFFER_SIZE) == 0 || strncmp(data2,"MAIN_NODES_TO_NODES_PART_4_OF_ROUND_CREATE_NEW_BLOCK",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_VRF_DATA",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_BLOCK_BLOB_SIGNATURE",BUFFER_SIZE) == 0 || strncmp(data2,"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_BLOCK_BLOB_SIGNATURE_TURBO_TX",BUFFER_SIZE) == 0 || strncmp(data2,"NODES_TO_NODES_VOTE_RESULTS",BUFFER_SIZE) == 0) && (strlen(buffer) >= MAXIMUM_BUFFER_SIZE))
    {
      pointer_reset(buffer);
      return;
    }
  ...
  else if (strstr(buffer,"|") != NULL)
  {
    ...
    if (strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_GET_PREVIOUS_CURRENT_NEXT_BLOCK_VERIFIERS_LIST",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_REMOTE_DATA_GET_ADDRESS_SETTINGS",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_REMOTE_DATA_GET_ADDRESS_FROM_NAME",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_REMOTE_DATA_GET_INFORMATION_FROM_NAME",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_UPDATE_REMOTE_DATA",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_SAVE_NAME",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_PURCHASE_NAME",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_SET_AMOUNT",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_RENEWAL_START",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_RENEWAL_END",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_GET_CURRENT_BLOCK_VERIFIERS_LIST",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_BLOCK_VERIFIERS_GET_RESERVE_BYTES_DATABASE_HASH",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_RESERVE_BYTES_DATABASE_SYNC_CHECK_ALL_UPDATE",BUFFER_SIZE) != 0 && strncmp(data2,"XCASH_PROOF_OF_STAKE_TEST_DATA",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_BLOCK_VERIFIERS_ADD_RESERVE_PROOF",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_REGISTER_DELEGATE",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_RECOVER_DELEGATE",BUFFER_SIZE) != 0 && strncmp(data2,"NODES_TO_BLOCK_VERIFIERS_UPDATE_DELEGATE",BUFFER_SIZE) != 0 && strncmp(data2,"NODE_TO_NETWORK_DATA_NODES_CHECK_VOTE_STATUS",BUFFER_SIZE) != 0)
    {
      pointer_reset(buffer);
      return;
    }
 ...
 else if (strstr(buffer,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_SAVE_NAME") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_nodes_to_block_verifiers_save_name(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_PURCHASE_NAME") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_nodes_to_block_verifiers_purchase_name(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_SET_AMOUNT") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_nodes_to_block_verifiers_delegates_set_amount(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_RENEWAL_START") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_nodes_to_block_verifiers_renewal_start(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"NODES_TO_BLOCK_VERIFIERS_REMOTE_DATA_RENEWAL_END") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_nodes_to_block_verifiers_renewal_end(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"\"message_settings\": \"NETWORK_DATA_NODES_TO_NETWORK_DATA_NODES_REMOTE_DATA_DATABASE_SYNC_CHECK\"") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_network_data_nodes_to_network_data_nodes_database_sync_check_remote_data((const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 else if (strstr(buffer,"\"message_settings\": \"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_SYNC_CHECK_UPDATE\"") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_public_addresses(1,(const char*)buffer) == 1)
   {
     server_receive_data_socket_block_verifiers_to_block_verifiers_remote_data_database_sync_check_update(CLIENT_SOCKET,(const char*)buffer);
     server_limit_public_addresses(3,(const char*)buffer);
   }
 }
 else if (strstr(buffer,"\"message_settings\": \"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DATABASE_DOWNLOAD_FILE_UPDATE\"") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_public_addresses(1,(const char*)buffer) == 1)
   {
    server_receive_data_socket_block_verifiers_to_block_verifiers_remote_data_database_download_file_update(CLIENT_SOCKET);
    server_limit_public_addresses(3,(const char*)buffer);
   }
 }
 else if (strstr(buffer,"\"message_settings\": \"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_SYNC_CHECK_UPDATE\"") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_public_addresses(1,(const char*)buffer) == 1)
   {
     server_receive_data_socket_block_verifiers_to_block_verifiers_remote_data_delegates_database_sync_check_update(CLIENT_SOCKET,(const char*)buffer);
     server_limit_public_addresses(3,(const char*)buffer);
   }
 }
 else if (strstr(buffer,"\"message_settings\": \"BLOCK_VERIFIERS_TO_BLOCK_VERIFIERS_REMOTE_DATA_DELEGATES_DATABASE_DOWNLOAD_FILE_UPDATE\"") != NULL && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_public_addresses(1,(const char*)buffer) == 1)
   {
    server_receive_data_socket_block_verifiers_to_block_verifiers_remote_data_delegates_database_download_file_update(CLIENT_SOCKET);
    server_limit_public_addresses(3,(const char*)buffer);
   }
 }
 ...
 else if (strstr(buffer,"GET /remotedatagetnamestatus?parameter1=") != NULL && delegates_website == 1 && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_get_name_status(CLIENT_SOCKET,(const char*)buffer);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 }
 ...
 else if (strstr(buffer,"GET /remotedatagetdelegatesinformation") != NULL && delegates_website == 1 && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
     server_receive_data_socket_remote_data_get_delegates_information(CLIENT_SOCKET);
     server_limit_IP_addresses(0,(const char*)client_IP_address);
   }
 } 
 else if (strstr(buffer,"GET /remotedatagetblockproducerinformation") != NULL && delegates_website == 1 && current_block_height_data >= BLOCK_HEIGHT_REMOTE_DATA_DELEGATES)
 {
   if (server_limit_IP_addresses(1,(const char*)client_IP_address) == 1)
   {
