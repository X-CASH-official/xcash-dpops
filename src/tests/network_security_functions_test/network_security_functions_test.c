...
{  
  ...
  fprintf(stderr,"\033[1;34mnetwork security functions test - Total test: %d\033[0m\n",NETWORK_SECURITY_FUNCTIONS_TEST);
  color_print(TEST_OUTLINE,"blue");
  fprintf(stderr,"\n");
  ...
  if (count_test == NETWORK_SECURITY_FUNCTIONS_TEST)
  {
    fprintf(stderr,"\n");
    color_print(TEST_OUTLINE,"green");
    fprintf(stderr,"\033[1;32mnetwork security functions test - Passed test: %d, Failed test: 0\033[0m\n",NETWORK_SECURITY_FUNCTIONS_TEST);
    color_print(TEST_OUTLINE,"green");
    fprintf(stderr,"\n\n");
  }
  else
  {
    ...
    fprintf(stderr,"\033[1;31mnetwork security functions test - Passed test: %d, Failed test: %d\033[0m\n",count_test,NETWORK_SECURITY_FUNCTIONS_TEST-count_test);
    color_print(TEST_OUTLINE,"red");
    fprintf(stderr,"\n\n");
  } 
  return count_test;
