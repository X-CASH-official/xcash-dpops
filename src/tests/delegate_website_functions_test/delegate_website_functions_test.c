...
int delegate_website_functions_test(void)
{
  ...
  // run the test
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_DELEGATES_WEBSITE_GET_STATISTICS_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_STATISTICS_TEST_DATA,sizeof(data_test)) == 0)
  {
  ...
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_GET_DELEGATES_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_DELEGATES_TEST_DATA,sizeof(data_test)) == 0)
  {
  ...
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_GET_DELEGATES_STATISTICS_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_DELEGATES_STATISTICS_TEST_DATA,sizeof(data_test)) == 0)
  {
  ...
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_GET_DELEGATES_INFORMATION_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_DELEGATES_INFORMATION_TEST_DATA,sizeof(data_test)) == 0)
  {
  ...
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_GET_DELEGATES_VOTERS_LIST_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_DELEGATES_VOTERS_LIST_TEST_DATA,sizeof(data_test)) == 0)
  {
  ...
  memset(data_test,0,sizeof(data_test));
  if (send_and_receive_data_socket(data_test,"127.0.0.1",SEND_DATA_PORT,SERVER_RECEIVE_DATA_SOCKET_GET_ROUND_STATISTICS_TEST_DATA,SEND_OR_RECEIVE_SOCKET_DATA_TIMEOUT_SETTINGS) == 1 && parse_http_response(data_test) == 1 && strncmp(data_test,DELEGATE_WEBSITE_GET_ROUND_STATISTICS_TEST_DATA,sizeof(data_test)) == 0)
  {
