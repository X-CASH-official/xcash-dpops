...
int delegate_website_functions_test(void)
{
  ...
  #define DELEGATE_WEBSITE_GET_DELEGATES_INFORMATION_TEST_DATA "{\"public_address\":\"" TEST_WALLET_1 "\",\"about\":\"\",\"website\":\"\",\"team\":\"\",\"shared_delegate_status\":\"false\",\"fee_structure\":\"\",\"server_settings\":\"\"}"
