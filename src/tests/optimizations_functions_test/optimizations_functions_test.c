...
int optimizations_functions_test(void)
{
  ...
  #define MAXIMUM_TIME_BLOCK_VERIFIERS_SEND_DATA_SOCKET START_TIME_SECONDS_NETWORK_BLOCK_PART_2
  ...
  #define MAXIMUM_TIME_VRF_DATA_VERIFY SEND_DATA_TIME_NETWORK_BLOCK_PART_4 - START_TIME_SECONDS_NETWORK_BLOCK_PART_4
  #define MAXIMUM_TIME_VRF_DATA_VERIFY_MULTITHREADED SEND_DATA_TIME_SECONDS_NETWORK_BLOCK_PART_4 - START_TIME_SECONDS_NETWORK_BLOCK_PART_4
  #define MAXIMUM_TIME_NETWORK_BLOCK_PART_1 START_TIME_SECONDS_NETWORK_BLOCK_PART_2
  #define MAXIMUM_TIME_NETWORK_BLOCK_PART_2 START_TIME_SECONDS_NETWORK_BLOCK_PART_3 - START_TIME_SECONDS_NETWORK_BLOCK_PART_2
  #define MAXIMUM_TIME_NETWORK_BLOCK_PART_3 START_TIME_SECONDS_NETWORK_BLOCK_PART_4 - START_TIME_SECONDS_NETWORK_BLOCK_PART_3
  #define MAXIMUM_TIME_NETWORK_BLOCK_PART_4 SEND_DATA_TIME_SECONDS_NETWORK_BLOCK_PART_4 - START_TIME_SECONDS_NETWORK_BLOCK_PART_4
  #define MAXIMUM_TIME_NETWORK_BLOCK_PART_5 START_TIME_SECONDS_NETWORK_BLOCK_PART_5 - SEND_DATA_TIME_SECONDS_NETWORK_BLOCK_PART_4
  ...
  for (count = 0; count < MAXIMUM_INVALID_RESERVE_PROOFS * 0.10; count++)
  {
    ...
    invalid_reserve_proofs.public_address_voted_for[count] = (char*)calloc(XCASH_WALLET_LENGTH+1,sizeof(char));
    invalid_reserve_proofs.reserve_proof[count] = (char*)calloc(BUFFER_SIZE_RESERVE_PROOF,sizeof(char));
    memcpy(invalid_reserve_proofs.block_verifier_public_address[count],TEST_WALLET_1,XCASH_WALLET_LENGTH);
    memcpy(invalid_reserve_proofs.public_address_voted_for[count],TEST_WALLET_6,XCASH_WALLET_LENGTH);
    memcpy(invalid_reserve_proofs.public_address_created_reserve_proof[count],TEST_WALLET_11,XCASH_WALLET_LENGTH);
