...
int block_verifiers_thread_server_functions_test(void)
{
  ...
  invalid_reserve_proofs.count = 1;
  if (send_invalid_reserve_proof_to_block_verifiers(&reserve_proof) == 1 && memcmp(invalid_reserve_proofs.reserve_proof[0],"",1) == 0)
  {
