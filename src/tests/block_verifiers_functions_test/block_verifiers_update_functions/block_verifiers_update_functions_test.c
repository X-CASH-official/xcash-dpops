...
int block_verifiers_update_functions_test(void)
{
  ...
  if (add_block_verifiers_round_statistics(XCASH_PROOF_OF_STAKE_BLOCK_HEIGHT_TEST) == 1 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"" TEST_WALLET_1 "\"}","block_verifier_total_rounds",data_test,1) == 1 && strncmp(data_test,"1",sizeof(data_test)) == 0 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"" TEST_WALLET_1 "\"}","block_verifier_online_total_rounds",result_test,1) == 1 && strncmp(result_test,"1",sizeof(result_test)) == 0 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"" TEST_WALLET_1 "\"}","block_verifier_online_percentage",data,1) == 1 && strncmp(data,"100",sizeof(data)) == 0)
  {
