...
int block_verifiers_update_functions_test(void)
{
  ...
  update_block_verifiers_list();
  if (strncmp(previous_block_verifiers_list.block_verifiers_name[0],"delegate_2",BUFFER_SIZE) == 0 && strncmp(current_block_verifiers_list.block_verifiers_name[0],"delegate_3",BUFFER_SIZE) == 0 && strncmp(next_block_verifiers_list.block_verifiers_public_address[0],"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP",BUFFER_SIZE) == 0)
  {
  ...
  if (add_block_verifiers_round_statistics(XCASH_PROOF_OF_STAKE_BLOCK_HEIGHT_TEST) == 1 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP\"}","block_verifier_total_rounds",data_test,1) == 1 && strncmp(data_test,"1",sizeof(data_test)) == 0 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP\"}","block_verifier_online_total_rounds",result_test,1) == 1 && strncmp(result_test,"1",sizeof(result_test)) == 0 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP\"}","block_verifier_online_percentage",data,1) == 1 && strncmp(data,"100",sizeof(data)) == 0)
  {
  ...
  memcpy(main_nodes_list.block_producer_public_address,"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP",XCASH_WALLET_LENGTH);
  if (add_block_verifiers_round_statistics(XCASH_PROOF_OF_STAKE_BLOCK_HEIGHT_TEST) == 1 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP\"}","block_producer_total_rounds",data_test,1) == 1 && strncmp(data_test,"1",sizeof(data_test)) == 0 && read_document_field_from_collection(database_name,"delegates","{\"public_address\":\"XCA1pEWxj2q7gn7TJjae7JfsDhtnhydxsHhtADhDm4LbdE11rHVZqbX5MPGZ9tM7jQbDF4VKK89jSAqgL9Nxxjdh8RM5JEpZZP\"}","block_producer_block_heights",result_test,1) == 1 && strncmp(result_test,"|" XCASH_PROOF_OF_STAKE_BLOCK_HEIGHT_TEST,sizeof(result_test)) == 0)
  {
  ...
  if (add_round_statistics() == 1 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","most_total_rounds_delegate_name",data_test,1) == 1 && strncmp(data_test,"delegate_name_5",sizeof(data_test)) == 0 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","most_total_rounds",result_test,1) == 1 && strncmp(result_test,"5",sizeof(result_test)) == 0 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","best_block_verifier_online_percentage_delegate_name",data,1) == 1 && strncmp(data,"delegate_name_2",sizeof(data)) == 0 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","best_block_verifier_online_percentage",data2,1) == 1 && strncmp(data2,"100",sizeof(data2)) == 0 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","most_block_producer_total_rounds_delegate_name",message,1) == 1 && strncmp(message,"delegate_name_4",sizeof(message)) == 0 && read_document_field_from_collection(database_name,"statistics","{\"username\":\"XCASH\"}","most_block_producer_total_rounds",message2,1) == 1 && strncmp(message2,"2",sizeof(message2)) == 0)
  {
  ...
  if (calculate_main_nodes_roles() == 1 && strncmp(main_nodes_list.block_producer_public_address,"public_address_2",sizeof(main_nodes_list.block_producer_public_address)) == 0 && strncmp(main_nodes_list.block_producer_backup_block_verifier_1_public_address,"public_address_0",sizeof(main_nodes_list.block_producer_backup_block_verifier_1_public_address)) == 0 && strncmp(main_nodes_list.block_producer_backup_block_verifier_2_public_address,"public_address_7",sizeof(main_nodes_list.block_producer_backup_block_verifier_2_public_address)) == 0 && strncmp(main_nodes_list.block_producer_backup_block_verifier_3_public_address,"public_address_9",sizeof(main_nodes_list.block_producer_backup_block_verifier_3_public_address)) == 0 && strncmp(main_nodes_list.block_producer_backup_block_verifier_4_public_address,"public_address_1",sizeof(main_nodes_list.block_producer_backup_block_verifier_4_public_address)) == 0 && strncmp(main_nodes_list.block_producer_backup_block_verifier_5_public_address,"public_address_3",sizeof(main_nodes_list.block_producer_backup_block_verifier_5_public_address)) == 0)
  {
