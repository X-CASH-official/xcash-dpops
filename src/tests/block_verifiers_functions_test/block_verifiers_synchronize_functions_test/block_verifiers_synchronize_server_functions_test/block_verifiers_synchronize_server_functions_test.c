...
int block_verifiers_synchronize_server_functions_test(void)
{
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,GET_PREVIOUS_CURRENT_NEXT_BLOCK_VERIFIERS_LIST_TEST_DATA,sizeof(GET_PREVIOUS_CURRENT_NEXT_BLOCK_VERIFIERS_LIST_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,GET_CURRENT_BLOCK_VERIFIERS_LIST_TEST_DATA,sizeof(GET_CURRENT_BLOCK_VERIFIERS_LIST_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,RESERVE_BYTES_SYNC_CHECK_ALL_UPDATE_TEST_DATA,sizeof(RESERVE_BYTES_SYNC_CHECK_ALL_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,GET_RESERVE_BYTES_DATABASE_HASH_TEST_DATA,sizeof(GET_RESERVE_BYTES_DATABASE_HASH_TEST_DATA)-1) == 0)
  {
  ...
  RESET_ERROR_MESSAGES;
  memcpy(data_test,"{\r\n \"message_settings\": \"NODE_TO_BLOCK_VERIFIERS_GET_RESERVE_BYTES_DATABASE_HASH\",\r\n \"block_height\": \"521855\",\r\n}",113);
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,GET_RESERVE_BYTES_DATABASE_HASH_LIVE_SYNCING_TEST_DATA,sizeof(GET_RESERVE_BYTES_DATABASE_HASH_LIVE_SYNCING_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,"0}",2) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,RESERVE_PROOFS_SYNC_CHECK_ALL_UPDATE_TEST_DATA,sizeof(RESERVE_PROOFS_SYNC_CHECK_ALL_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,RESERVE_PROOFS_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA,sizeof(RESERVE_PROOFS_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,RESERVE_BYTES_SYNC_CHECK_ALL_UPDATE_TEST_DATA_RESULTS,sizeof(RESERVE_BYTES_SYNC_CHECK_ALL_UPDATE_TEST_DATA_RESULTS)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,RESERVE_BYTES_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA,sizeof(RESERVE_BYTES_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,DELEGATES_SYNC_CHECK_ALL_UPDATE_TEST_DATA,sizeof(DELEGATES_SYNC_CHECK_ALL_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,DELEGATES_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA,sizeof(DELEGATES_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,STATISTICS_SYNC_CHECK_ALL_UPDATE_TEST_DATA,sizeof(STATISTICS_SYNC_CHECK_ALL_UPDATE_TEST_DATA)-1) == 0)
  {
  ...
  if (sign_data(data_test,0) == 1 && send_and_receive_data_socket(result_test,"127.0.0.1",SEND_DATA_PORT,data_test,RECEIVE_DATA_TIMEOUT_SETTINGS,"",0) == 1 && memcmp(result_test,STATISTICS_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA,sizeof(STATISTICS_DATABASE_DOWNLOAD_FILE_UPDATE_TEST_DATA)-1) == 0)
  {
