...
{
  // define macros
  #define ORGANIZE_FUNCTIONS_TOTAL_TEST 2
  #define MAXIMUM_DELEGATES_AMOUNT 3
  ...
  for (count = 0; (int)count < MAXIMUM_DELEGATES_AMOUNT; count++)
  {
  ...
  qsort(delegates,MAXIMUM_DELEGATES_AMOUNT,sizeof(struct delegates),organize_delegates_settings);
