...
int main_node_to_node_message_part_1(const int CLIENT_SOCKET, struct mainnode_timeout_thread_parameters* parameters, struct node_to_node_timeout_thread_parameters* node_to_node_timeout_thread_parameters, char* message);
